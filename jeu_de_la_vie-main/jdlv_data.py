...
beige = 'sandybrown'
life_color = 'black'
life_color1 = 'darkgray'
life_color2 = 'pink'
life_color3 = 'mediumvioletred'
...
colors = ["red","mediumvioletred", "orchid", "sandybrown", "blue", "yellow", "pink", "green","darkgray", "black", "white", "cyan", "orange", "lime","grey", "gray", "dimgrey", "blueviolet", "deepskyblue", "magenta","sandybrown","orchid","navy"]
brushes = {}
for color in colors:
    brushes [color] = QtGui.QBrush (QtGui.QColor (color))

default_empty_file_name = "Niancat.pioche"

text_enregistrer_sous = "Enregistrer sous"
text_directory_of_examples ="Répertoire d'exemples .pioche"
